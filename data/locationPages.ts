...
export const LOCATION_PAGES: LocationPage[] = [
  {
    ...
    title: "Wholesale Tea Supplier in Siliguri 2026 | Direct Garden Fresh CTC & Dust",
    metaDescription: "Direct from Siliguri's Mahananda Para market. 20+ years supply experience. Min order 25kg. Free samples. Trusted by 200+ retailers across India. Get a quote today.",
    heading: "Wholesale Tea Supplier in Siliguri 2026 | Direct Garden Fresh CTC & Dust",
    content: `
      <p>Welcome to <strong>Manish Tea Traders</strong>, your trusted wholesale tea partner in Siliguri, West Bengal. As one of the leading tea suppliers in North Bengal, we bring you fresh, authentic teas straight from the gardens of Dooars, Terai, and Darjeeling at wholesale prices that cut out the middleman. With 20+ years of experience in the heart of India's tea trading hub, we provide more than just tea—we provide the competitive edge your business needs.</p>
      

      <h3>Why Siliguri is India's Tea Trading Hub</h3>
      <p>Siliguri isn't just another city—it's the beating heart of India's tea industry. Nestled at the foothills of the Himalayas, our city serves as the primary trading center for tea produced across North Bengal and the Northeast. Every week, thousands of kilograms of premium tea pass through the <strong>Siliguri Tea Auction Centre (STAC)</strong>, making this the most important location for anyone serious about quality tea sourcing. <strong>Manish Tea Traders</strong> is located just minutes from the auction house, giving us the first pick of every single lot that comes to market.</p>

      <h3>Wholesale Tea Price List 2026 (Estimated Rates)</h3>
      <p>The tea market is dynamic, but we believe in transparency. Below are the estimated wholesale price ranges for popular grades in 2026, sourced directly from Siliguri and Dooars auctions. These prices are for bulk orders (minimum 10-20 bags).</p>
      
      <div class="overflow-x-auto my-6 border rounded-lg">
        <table class="min-w-full divide-y divide-gray-200 text-sm">
          <thead class="bg-tea-50">
            <tr>
              <th class="px-4 py-2 text-left font-bold text-tea-900 border-r">Tea Grade / Variety</th>
              <th class="px-4 py-2 text-left font-bold text-tea-900 border-r">Primary Market</th>
              <th class="px-4 py-2 text-left font-bold text-tea-900">Estimated Price (₹/kg)</th>
            </tr>
          </thead>
          <tbody class="divide-y divide-gray-200">
            <tr>
              <td class="px-4 py-2 border-r">Premium CTC Leaf (BOPL/BOP)</td>
              <td class="px-4 py-2 border-r">Retail, Branding</td>
              <td class="px-4 py-2">₹160 – ₹240</td>
            </tr>
            <tr>
              <td class="px-4 py-2 border-r">Standard CTC Dust (PD/RD)</td>
              <td class="px-4 py-2 border-r">Hotels, Tea Stalls</td>
              <td class="px-4 py-2">₹120 – ₹170</td>
            </tr>
            <tr>
              <td class="px-4 py-2 border-r">Assam CTC (Strong/Malty)</td>
              <td class="px-4 py-2 border-r">Interstate Bulk Buyers</td>
              <td class="px-4 py-2">₹190 – ₹310</td>
            </tr>
            <tr>
              <td class="px-4 py-2 border-r">Darjeeling Orthodox (Blend Grade)</td>
              <td class="px-4 py-2 border-r">Specialty Shops</td>
              <td class="px-4 py-2">₹350 – ₹800+</td>
            </tr>
            <tr>
              <td class="px-4 py-2 border-r">Hotel/Canteen Dust (Economy)</td>
              <td class="px-4 py-2 border-r">High Volume Canteens</td>
              <td class="px-4 py-2">₹105 – ₹135</td>
            </tr>
          </tbody>
        </table>
      </div>
      <p class="text-xs text-gray-500 italic mb-6">*Note: Prices vary weekly based on auction results. Contact us for today's exact rates.*</p>

      <h3>The Manish Tea Traders Difference: Sourcing Excellence</h3>
      
      <h4>Direct Auction Participation at STAC</h4>
      <p>Unlike secondary wholesalers who buy from other traders, we are direct participants in the <strong>Siliguri Tea Auction Centre (STAC)</strong>. Every Tuesday and Wednesday, our expert tasters evaluate hundreds of samples from premier gardens in the Dooars and Terai regions. We bid on lots that offer the best balance of liquor strength, infusion color, and leaf appearance. This direct sourcing eliminates middleman margins of 10-15%, which we pass directly to you.</p>

      <h4>Location-Enabled Freshness</h4>
      <p>Our warehouse and tasting center are strategically located in <strong>Mahananda Para, Siliguri</strong>—the nerve center of the tea trade. Being physically present here means we access freshly auctioned tea before it travels thousands of kilometers to reach hubs like Delhi or Mumbai. When you buy from us, you're getting tea that was plucked and processed just days ago, ensuring the volatile aromatic compounds are preserved.</p>

      <h3>Who We Serve: Our Diverse Wholesale Network</h3>
      
      <h4>1. Local Retailers & Distributors</h4>
      <p>If you run a tea shop in <strong>Khalpara, Sevoke Road, Hill Cart Road</strong>, or anywhere in North Bengal, we are your neighborhood partner. We supply quantities from 30 kg (one sack) to 500 kg, perfect for small businesses that need fresh stock without heavy capital investment.</p>

      <h4>2. Interstate Bulk Traders (Bihar, UP, Rajasthan)</h4>
      <p>We are a leading exporter of bulk tea from Siliguri to the <strong>Hindi Heartband</strong>. We understand the specific taste of Patna, the requirement for "Kadak" chai in Lucknow, and the preference for large-granule tea in Jaipur. We manage full truckload (FTL) dispatches to these states daily.</p>

      <h4>3. Private Label Brands & Packaging Houses</h4>
      <p>Thinking of starting your own brand? We provide the raw material. We supply unblended CTC Leaf, Dust, and Orthodox teas that you can blend and package under your own label. We also offer expert blending advice to help you match the taste profile of market leaders.</p>

      <h3>Our Comprehensive Product Range</h3>
      
      <h4>CTC Tea (Crush, Tear, Curl) - The Backbone of Indian Chai</h4>
      <ul>
        <li><strong>CTC Leaf Grade:</strong> BOP, BOPSM, BP, and PF grades for retail and household consumption.</li>
        <li><strong>CTC Dust Grade:</strong> PD, RD, and CD grades for hotel and institutional use. Ultra-fast brewing for "Cutting Chai".</li>
        <li><strong>Specialty Blends:</strong> Customized Dooars-Assam mixes for unique regional tastes.</li>
      </ul>

      <h4>Premium Orthodox & Black Teas</h4>
      <ul>
        <li>Whole leaf black tea with beautiful golden tips.</li>
        <li>Darjeeling First and Second Flush (GI Certified).</li>
        <li>Green Tea and specialty wellness blends.</li>
      </ul>

      <h3>Visit Our Tasting Center in Siliguri</h3>
      <p>We invite every serious buyer to visit our office in <strong>Mahananda Para</strong>. Before you commit to a 5-ton order, sit with us in our tasting room. <strong>What to expect:</strong></p>
      <ul>
        <li>Experience the "Slurp" – Learn how experts taste tea for quality.</li>
        <li>Compare color and briskness across 50+ garden samples.</li>
        <li>See the difference between "High-Elevation" and "Plains" tea.</li>
        <li>Get honest market guidance – we'll tell you which gardens are producing the best lots this month.</li>
      </ul>

      <h3>Bulk Logistics & Shipping Across India</h3>
      <p>Logistics is the most critical part of wholesale tea trading. <strong>Manish Tea Traders</strong> handles everything: from E-Way bills and GST documentation to choosing the right transport agent. We deliver to:</p>
      <ul>
        <li><strong>West Bengal & Northeast:</strong> 1-3 days.</li>
        <li><strong>North India (Delhi, UP, Haryana):</strong> 4-6 days.</li>
        <li><strong>Central India (MP, Chhattisgarh):</strong> 5-7 days.</li>
        <li><strong>South & West India:</strong> 7-9 days.</li>
      </ul>

      <h3>Why Choose Manish Tea Traders?</h3>
      <ul>
        <li>✓ <strong>20+ Years Excellence:</strong> A legacy built on trust and consistent quality since 2004.</li>
        <li>✓ <strong>Auction Proximity:</strong> Located in Mahananda Para, the heart of Siliguri's tea trade.</li>
        <li>✓ <strong>Quality over Quantity:</strong> Every bag is tested for moisture levels and consistent leaf size.</li>
        <li>✓ <strong>Flexible MOQ:</strong> From single bags (30kg) to multiple truckloads (10,000kg+).</li>
        <li>✓ <strong>Transparent Billing:</strong> Full GST invoices for all interstate transactions.</li>
      </ul>

      <h3>Start Your Tea Journey Today</h3>
    ...
    faqItems: [
      { question: "What is Siliguri famous for in the tea business?", answer: "Siliguri is India's largest tea trading hub, located at the junction of Darjeeling, Dooars, Terai and Assam growing regions. The Siliguri Tea Auction Centre (STAC) handles thousands of kg weekly, making it the primary price discovery point for North Bengal tea. Direct sourcing from Siliguri saves 15–20% versus buying from Delhi or Mumbai middlemen." },
      { question: "How to buy wholesale tea from Siliguri?", answer: "Contact established auction-registered traders like Manish Tea Traders. Request free samples first, verify GST registration and FSSAI compliance, then place a trial order of 30–100 kg. We dispatch via road transport with proper e-Way bills within 1–2 days of payment. Minimum order is just 30 kg (one sack) — no large upfront commitment required." },
      { question: "What is the wholesale price of tea in Siliguri in 2026?", answer: "Current 2026 wholesale prices range from ₹120–170/kg for hotel dust, ₹180–240/kg for standard CTC leaf (BP/BOP), ₹190–310/kg for premium Assam CTC, and ₹350–800+/kg for Darjeeling Orthodox. Prices fluctuate weekly based on auction results. WhatsApp us at +91 70019 58588 for today’s exact rates." }
    ]
  },
  {
    id: "siliguri-hindi",
    city: "Siliguri (Hindi)",
    slug: "siliguri-tea-wholesale-hindi",
    title: "सिलीगुड़ी चाय थोक विक्रेता 2026 | सिलिगुड़ी चाय मार्किट होलसेल रेट",
    metaDescription: "सिलीगुड़ी से सीधे गार्डन फ्रेश चाय। मनीष टी ट्रेडर्स - असम और डुआर्स सीटीसी चाय के थोक सप्लायर। 2026 की ताजा रेट लिस्ट के लिए संपर्क करें।",
    heading: "सिलीगुड़ी चाय थोक व्यापार 2026 | मनीष टी ट्रेडर्स - डायरेक्ट गार्डन फ्रेश",
    content: `
      <p><strong>मनीष टी ट्रेडर्स (Manish Tea Traders)</strong> में आपका स्वागत है। हम सिलीगुड़ी, पश्चिम बंगाल के प्रमुख चाय थोक विक्रेता (Wholesale Tea Supplier) हैं। अगर आप अपनी चाय की दुकान, ब्रांड या होलसेल व्यापार के लिए सीधे सिलीगुड़ी चाय मार्किट से जुड़ना चाहते हैं, तो आप सही जगह पर हैं। हम पिछले 20+ वर्षों से पूरे भारत में प्रीमियम सीटीसी (CTC) और डस्ट चाय की सप्लाई कर रहे हैं।</p>
      

      <h3>सिलीगुड़ी से चाय क्यों खरीदें? (Why Source from Siliguri?)</h3>
      <p>सिलीगुड़ी भारत का सबसे बड़ा चाय व्यापार केंद्र है। यहाँ से आपको डुआर्स (Dooars), तराई (Terai) और दार्जीलिंग (Darjeeling) के बागानों की ताजा चाय सीधे नीलामी (Auction) के बाद मिल सकती है। जब आप मनीष टी ट्रेडर्स से जुड़ते हैं, तो आप बिचौलियों (Middlemen) का कमीशन बचाते हैं और सीधे सोर्स (Source) से जुड़ते हैं।</p>

      <h3>हमारी चाय की वैरायटी (Our Tea Varieties)</h3>
      <ul>
        <li><strong>सीटीसी चाय (CTC Tea):</strong> कड़क चाय के लिए बेहतरीन दानेदार चाय।</li>
        <li><strong>होटल डस्ट (Hotel Dust):</strong> कम समय में ज्यादा रंग और स्वाद देने वाली चाय।</li>
        <li><strong>असम चाय (Assam Tea):</strong> खुशबूदार और मजबूत टेस्ट वाली असम सीटीसी।</li>
        <li><strong>दार्जीलिंग ऑर्थोडॉक्स (Darjeeling Orthodox):</strong> प्रीमियम और एक्सपोर्ट क्वालिटी चाय।</li>
      </ul>

      <h3>चाय थोक दाम 2026 (Wholesale Rates 2026)</h3>
      <p>चाय के रेट हर हफ्ते नीलामी के आधार पर बदलते रहते हैं। सिलीगुड़ी मार्किट में अभी कड़क सीटीसी चाय 150 रुपये से लेकर 300 रुपये प्रति किलो तक उपलब्ध है। हम आपको बेहतरीन ग्रेड और क्वालिटी की गारंटी देते हैं।</p>

      <h3>माल की डिलीवरी और ट्रांसपोर्ट (Logistics & Delivery)</h3>
      <p>हम सिलीगुड़ी से सीधे बिहार (Patna, Gaya, Bhagalpur), उत्तर प्रदेश (Lucknow, Varanasi, Kanpur), राजस्थान, और दिल्ली में माल भेजते हैं। 30 किलो (एक बोरी) से लेकर फुल ट्रक लोड (FTL) तक का ऑर्डर आप दे सकते हैं।</p>

      <h3>मनीष टी ट्रेडर्स ही क्यों? (Why Us?)</h3>
      <ul>
        <li>✓ <strong>डायरेक्ट ऑक्शन एक्सेस:</strong> ताजा माल, कम दाम।</li>
        <li>✓ <strong>क्वालिटी टेस्टिंग:</strong> हर बोरी की टेस्टिंग और चखने (Tasting) के बाद ही डिस्पैच।</li>
        <li>✓ <strong>भरोसा:</strong> 2004 से चाय व्यापार में सक्रिय।</li>
        <li>✓ <strong>फ्री सैंपल:</strong> बड़े ऑर्डर से पहले आप चाय का सैंपल मंगवा सकते हैं।</li>
      </ul>

      <h3>हमसे संपर्क करें (Contact Us)</h3>
      <p><strong>पता:</strong> मनीष टी ट्रेडर्स, महानंदा पाड़ा, सिलीगुड़ी - 734005।</p>
      <p>आज ही हमसे जुड़ें और अपने चाय के व्यापार को नई ऊंचाइयों पर ले जाएं। कॉल करें: <strong>+91 70019 58588</strong>।</p>

      <p class="text-xs text-gray-400 mt-8"><em>Keywords: चाय थोक विक्रेता सिलीगुड़ी, सीटीसी चाय होलसेल, असम चाय सप्लायर, सिलीगुड़ी चाय मार्किट रेट, tea wholesaler siliguri hindi, bulk tea supplier bihar up, manish tea traders contact.</em></p>
    `,
    lang: 'hi',
    translationId: 'siliguri'
  },
  {
    ...
    title: "Wholesale Tea Suppliers in Kolkata 2026 | Direct Garden Fresh",
    metaDescription: "Fresh North Bengal tea to Kolkata. 24-48hr express delivery. Serving Burrabazar, Salt Lake & KMC. Direct auction prices. 2026 Price List available.",
    heading: "Wholesale Tea Suppliers in Kolkata 2026 | Direct Garden Fresh",
    content: `
      ...
      <p>Kolkata consumers are among the most discerning in India. They know the difference between "garden-fresh" tea and old stock that has lost its briskness. Our proximity to the source in Siliguri allows us to deliver tea to Kolkata within 24–48 hours of dispatch, ensuring it retains the characteristic aroma and flavor profile that Kolkata buyers demand.</p>

      <h3>Serving Every Corner of the Kolkata Metropolitan Area</h3>
      
      <h4>Burrabazar & Posta – The Trading Heart</h4>
      <p>The narrow lanes of Burrabazar have been the epicenter of Kolkata's trade for over a century. We supply established wholesalers and redistribution agents in <strong>Burrabazar, Posta, and Canning Street</strong>. Our bulk consignments arrive in double-layered HDPE or traditional jute bags, ready for the fast-paced redistribution that characterizes this market hub.</p>

      <h4>Salt Lake & Rajarhat – The Corporate Sector</h4>
      <p>Kolkata's IT hubs in Sector V and Rajarhat have a massive requirement for consistent, high-quality office tea. We provide "Bulk Office Blends" that maintain their strength even when prepared in large urns. These blends are optimized for corporate catering, offering a refreshing break for thousands of employees daily.</p>

      <h4>South Kolkata – Premium Retail Segment</h4>
      <p>From Gariahat to Jadavpur, South Kolkata households prefer premium Assam Leaf and Darjeeling Orthodox varieties. We supply high-end retailers in these areas with garden-marked invoices, ensuring their customers get exactly what's on the label.</p>

      <h3>Kolkata Delivery Logistics: Siliguri Express</h3>
      <p>Kolkata is our most frequently served market outside our hometown. What this means for you:
      <ul>
        <li><strong>Express Transport:</strong> Goods reaching Kolkata transport depots (mostly in the Posta/Bally area) in just 1-2 nights.</li>
        <li><strong>Door-Step Godown Delivery:</strong> For orders exceeding 1,000kg, we arrange direct delivery to your warehouse within KMC limits.</li>
        <li><strong>Handling Documentation:</strong> Full compliance with WB E-Way bills and local trade regulations.</li>
      </ul>

      <h3>Popular Blends for Kolkata</h3>
      <ul>
        <li><strong>"Kolkata Special" Mix:</strong> A 70:30 blend of Dooars and Assam that delivers the golden-red liquor beloved in local tea stalls.</li>
        <li><strong>Hotel Grade Dust:</strong> Sourced from top-tier Terai gardens for maximum "Kadakness".</li>
        <li><strong>Darjeeling First Flush:</strong> Seasonal availability for heritage tea shops in North Kolkata.</li>
      </ul>

      <h3>Why Source from Siliguri instead of Kolkata Auctions?</h3>
      <p>While Kolkata has its own auction center, buying from <strong>Manish Tea Traders in Siliguri</strong> offers two distinct advantages: 
      1. **Freshness:** You get the tea closer to the processing date. 
      2. **Price:** We cut out the extra handling and warehouse costs associated with Kolkata auction stocks. 
      By the time tea reaches Kolkata auctions, it has often been handled multiple times—we give it to you direct from the first handle.</p>

      <p><strong>Ready to refresh Kolkata with better tea?</strong> Contact us for today's Kolkata market rate list and sample dispatch details. Join our network of 50+ partners in the City of Joy.</p>
    `,
    lang: 'en',
    translationId: 'kolkata'
  },
  {
    id: "assam",
    city: "Assam",
    slug: "assam-tea-supplier",
    title: "Assam Tea Wholesale Supplier | Authentic Malty CTC Direct from Gardens",
    metaDescription: "Pure Assam tea wholesale supplier. Authentic malty CTC and Orthodox tea from Brahmaputra valley gardens. No mixing, no compromise on quality.",
    heading: "Assam Tea Wholesale Supplier – The Bold, Malty Character India Loves",
    content: `
  ...
  },
  {
    ...
    title: "Darjeeling Tea Wholesale | GI-Tagged First & Second Flush Direct from Gardens",
    metaDescription: "Authentic Darjeeling tea wholesale supplier. GI-certified First Flush, Second Flush, and Autumnal from prestigious gardens. Perfect for export and luxury retail.",
    heading: "Darjeeling Tea Wholesale – The Champagne of Teas, Direct from the Hills",
    content: `
    ...
    `,
    lang: 'en',
    translationId: 'darjeeling'
  },
  {
    id: "patna",
    city: "Patna",
    slug: "tea-wholesaler-patna-bihar",
    title: "Tea Wholesaler in Patna, Bihar 2026 | Kadak Chai Specialist",
    metaDescription: "Bihar's best kadak chai supplier. Optimized for local water. Strong CTC & Mota Dana. Regular transport to Patna Bypass. Start your tea brand in Bihar.",
    heading: "Tea Wholesaler in Patna, Bihar 2026 | Kadak Chai Specialist",
    content: `
      ...
      <h3>Why Bihar Tea Is Different: The Water Quality Factor</h3>
      <p>The water quality across Bihar varies significantly from other regions, often having higher mineral content (hard water). This affects how tea tannins are released during boiling. Generic tea blends often taste flat or overly bitter in Patna. We have developed Bihar-specific formulations that emphasize <strong>heavy color extraction</strong> and robust mouthfeel, ensuring consistent "Kadak" taste whether you're in Patna's Boring Road or a tea stall in Muzaffarpur.</p>

      <h3>Our Bihar-Focused Tea Range</h3>
      
      <h4>Lal Ghoda Style – The Color Champion</h4>
      <p>Bihar consumers judge tea quality by its color first. Our "Lal Ghoda" style blend produces that distinctive reddish-brown liquor that signals strength and quality. It's formulated to maintain color intensity even when re-heated multiple times—a common practice in Bihar households and rural tea stalls.</p>
      ...
      <h3>Logistics: Siliguri to Patna Bypass Made Simple</h3>
      <p>We maintain daily truck dispatches to Patna, with goods typically reaching transport nagars in the <strong>zero mile or bypass areas</strong> within 3-4 days. Our packaging is designed to withstand the rough handling common in long-distance transport—double-stitched jute bags with moisture-resistant inner lining. For bulk orders above 1,000kg, we arrange direct delivery to your godown in Patna or Muzaffarpur.</p>

      <h3>Starting a Tea Business in Bihar?</h3>
      <p>Bihar is currently one of the fastest-growing markets for new tea brands. We don't just supply tea; we help you build your brand:
      <ul>
        <li><strong>Sample Testing:</strong> Send us your local water sample, and we will recommend the perfect blend.</li>
        <li><strong>Pricing Strategy:</strong> We help you compete with established brands by offering better quality at 15% lower cost due to direct Siliguri sourcing.</li>
        <li><strong>Market Guidance:</strong> Insights into which districts (Gaya, Bhagalpur, Purnia) are currently showing the highest demand.</li>
      </ul>

      <p><strong>Stop paying middleman margins.</strong> Source directly from Siliguri and improve your profit while maintaining the quality your Bihar customers expect. Contact Manish Tea Traders today for today's price list.</p>
    `,
    lang: 'en',
    translationId: 'patna'
  },
  {
    id: "patna-hindi",
    city: "Patna (Hindi)",
    slug: "tea-wholesaler-patna-hindi",
    title: "पटना चाय थोक विक्रेता 2026 | बिहार के लिए बेहतरीन कड़क चाय",
    metaDescription: "पटना और बिहार के लिए चाय थोक विक्रेता। सिलीगुड़ी से सीधे गार्डन फ्रेश चाय। बिहार के पानी के हिसाब से तैयार कड़क सीटीसी चाय। 2026 रेट लिस्ट के लिए संपर्क करें।",
    heading: "पटना चाय थोक व्यापार 2026 | बिहार की पसंद - कड़क और लाल चाय",
    content: `
      <p>बिहार में चाय सिर्फ एक पेय नहीं, बल्कि एक संस्कृति है। और जब बात पटना की हो, तो यहाँ के लोग <strong>"कड़क चाय"</strong> के मामले में कोई समझौता नहीं करते। <strong>मनीष टी ट्रेडर्स (Manish Tea Traders)</strong> पिछले कई सालों से बिहार के बाजार को करीब से समझ रहा है। हम जानते हैं कि पटना, गया, भागलपुर और मुजफ्फरपुर के लोगों को कैसी चाय पसंद है।</p>

      <h3>बिहार के पानी के लिए खास चाय (Tea Optimized for Bihar Water)</h3>
      <p>बिहार के ज्यादातर इलाकों में पानी में मिनरल्स (Hard Water) ज्यादा होते हैं, जिससे सामान्य चाय का रंग और स्वाद वैसा नहीं आता जैसा आना चाहिए। हमने अपनी चाय को बिहार के पानी के हिसाब से टेस्ट और ब्लेंड किया है, ताकि आपको मिले बेहतरीन <strong>लाल गाढ़ा रंग</strong> और जबरदस्त कड़कपन।</p>

      <h3>हमारी पटना और बिहार रेंज (Our Range for Bihar)</h3>
      <ul>
        <li><strong>मोटा दाना (BOPL):</strong> बिहार के घरों में पसंद की जाने वाली बड़े दाने की चाय।</li>
        <li><strong>होटल डस्ट (Dust):</strong> पटना के चाय स्टालों के लिए स्पेशल, जो कम समय में ज्यादा रंग और कड़कपन दे।</li>
        <li><strong>असम सीटीसी (Assam CTC):</strong> खुशबूदार और मजबूत टेस्ट वाली प्रीमियम चाय।</li>
      </ul>

      <h3>सिलीगुड़ी से पटना - डायरेक्ट सप्लाई (Direct Supply from Siliguri)</h3>
      <p>हमारा माल सीधे सिलीगुड़ी से पटना के ट्रांसपोर्ट नगर (Bypass) में 3-4 दिनों के अंदर पहुँच जाता है। आप 30 किलो (एक बोरी) से लेकर फुल ट्रक का ऑर्डर दे सकते हैं।</p>

      <h3>संपर्क करें (Contact Us)</h3>
      <p>आज ही सिलीगुड़ी से सीधे जुड़ें और बिचौलियों का कमीशन बचाएं। कॉल करें: <strong>+91 70019 58588</strong>।</p>
    `,
    lang: 'hi',
    translationId: 'patna'
  },
  {
    ...
    title: "Wholesale Tea Supplier in Ranchi, Jharkhand | Fresh Garden Stock",
    metaDescription: "Trusted bulk tea supplier for Ranchi, Jamshedpur, and Dhanbad. Fresh Assam and Dooars tea optimized for Jharkhand's water quality.",
    heading: "Wholesale Tea Supplier in Ranchi & Jharkhand – Quality That Suits Your Water",
    content: `
    ...
    `,
    lang: 'en',
    translationId: 'ranchi'
  },
  {
    id: "delhi",
    city: "Delhi",
    slug: "wholesale-tea-supplier-delhi",
    title: "Wholesale Tea Supplier in Delhi NCR 2026 | Khari Baoli Bulk Supply",
    metaDescription: "Direct Siliguri to Delhi NCR. Serving Khari Baoli traders & brands. Fresh Assam & CTC tea. 100kg to FTL orders. Request tea samples for Delhi. 2026 Rates.",
    heading: "Wholesale Tea Supplier in Delhi NCR 2026 | Khari Baoli Bulk Supply",
    content: `
      ...
      <p>In the National Capital Region (NCR), tea is more than a break—it's a massive industry. Whether you're supplying high-end cafes in <strong>Gurgaon</strong> or wholesale traders in <strong>Khari Baoli</strong>, the requirement is the same: consistency. Delhi's water (particularly in parts of West Delhi and Noida) can be hard, which makes tea infusion slower. We provide specific blends that are "color-extracted" faster to compensate for these water variations.</p>

      <h3>Serving Delhi's Global Commercial Trading Hubs</h3>
      
      <h4>Khari Baoli – Asia's Wholesale Nerve Center</h4>
      <p>Khari Baoli has been India's primary spice and tea hub for centuries. We provide full-truckload (FTL) supply to established trading houses in Old Delhi. Our auction-direct prices allow these traders to redistribute to smaller markets in Haryana, Punjab, and Western UP while maintaining healthy B2B margins.</p>

      <h4>Cyber City & Noida – The Corporate Powerhouses</h4>
      <p>The office complexes of Gurgaon and Noida consume millions of liters of tea every week. We supply specialized "Vending Machine" and "Tea-Bag" grade dust that tastes fresh even when dispensed through automated systems. Our corporate supply partners value our ability to provide consistent taste profiles across months of supply.</p>
      ...
      <h3>Delhi-NCR Logistics: The Siliguri-Azadpur Pipeline</h3>
      <p>Transporting tea from Siliguri to Delhi requires expert handling to avoid moisture damage. 
      <ul>
        <li><strong>Transit Time:</strong> Typically 4-6 days via dedicated tea transport routes.</li>
        <li><strong>Hubs:</strong> Goods primarily reach depots in **Azadpur, Mundka, or Burari**.</li>
        <li><strong>Custom Packaging:</strong> For Delhi traders, we offer 35kg "Nylon-Line" bags to prevent any flavor loss during the long journey across the plains.</li>
      </ul>

      <h3>Why Choose Us for Delhi Supply?</h3>
      <ul>
      ...
      <p><strong>Ready to source for the National Capital?</strong> Contact Manish Tea Traders for sample dispatch to your Delhi office. Experience why the biggest names in Khari Baoli trust us for their East India procurement.</p>
    `,
    lang: 'en',
    translationId: 'delhi'
  },
  {
    ...
    title: "Tea Wholesalers in Mumbai 2026 | Cutting Chai & Dust Specialists",
    metaDescription: "Mumbai's leading cutting chai supplier. PD/RD dust grades specialist. Direct Siliguri auction stock for Vashi APMC & retailers. Best 2026 rates.",
    heading: "Tea Wholesalers in Mumbai 2026 | Cutting Chai & Dust Specialists",
    content: `
    ...
    `,
    lang: 'en',
    translationId: 'mumbai'
  },
  {
    id: "bangalore",
    city: "Bangalore",
    slug: "tea-supplier-bangalore",
    title: "Bulk Tea Supplier in Bangalore | Premium Leaf, Dust & Green Tea",
    metaDescription: "Wholesale tea supplier for Bangalore's cafes, Darshinis, and IT campuses. Fresh Assam CTC, Orthodox leaf, and organic green tea in bulk.",
    heading: "Bulk Tea Supplier in Bangalore – Where Tech Meets Tea Tradition",
    content: `
    ...
    `,
    lang: 'en',
    translationId: 'bangalore'
  },
  {
    id: "jaipur",
    city: "Jaipur",
    slug: "tea-wholesaler-jaipur-rajasthan",
    title: "Tea Wholesaler in Jaipur, Rajasthan | Masala Chai & Strong CTC Specialists",
    metaDescription: "Premium wholesale tea for Jaipur and Rajasthan. Strong CTC blends perfect for traditional Rajasthani masala chai. Serving heritage hotels and local mandis.",
    heading: "Tea Wholesaler in Jaipur – Honoring Rajasthan's Tea Ritual",
    content: `
    ...
    `,
    lang: 'en',
    translationId: 'jaipur'
  },
  {
    id: "lucknow",
    city: "Lucknow",
    slug: "tea-supplier-lucknow-up",
    title: "Wholesale Tea Supplier in Lucknow, UP | Economy & Premium Blends",
    metaDescription: "Bulk tea supplier for Lucknow, Kanpur, and Uttar Pradesh. Economical CTC blends for high-volume sales. Awadh Special blend for traditional slow-boiled chai.",
    heading: "Wholesale Tea Supplier in Lucknow & Uttar Pradesh – Quality Meets Value",
    content: `
    ...
    `,
    lang: 'en',
    translationId: 'lucknow'
  },
  {
    id: "chennai",
    city: "Chennai",
    slug: "tea-wholesaler-chennai",
    title: "Tea Wholesaler in Chennai | Strong Assam Dust & Granules for South India",
    metaDescription: "Wholesale tea supplier for Chennai's growing tea market. Strong Assam dust and broken grades for ginger tea and dum tea. Humidity-resistant packaging.",
    heading: "Tea Wholesaler in Chennai – Strong Tea for the Filter Coffee Capital",
    content: `
    ...
    `,
    lang: 'en',
    translationId: 'chennai'
  },
  {
    id: "hyderabad",
    city: "Hyderabad",
    slug: "tea-supplier-hyderabad",
    title: "Irani Chai Tea Supplier Hyderabad 2026 | Wholesale Dust & Hotel Blends",
    metaDescription: "Specialized tea supplier for Hyderabad's Irani Chai. Strong dust and fine fanning grades for decoction-wide brewing. Serving Begum Bazar & Charminar cafes. 2026 Prices.",
    heading: "Wholesale Tea for Hyderabad 2026 – Perfecting the Legendary Irani Chai",
    content: `
      ...
      <h3>Technical Requirements for Perfect Irani Chai</h3>
      <p>Unlike regular chai that's boiled briefly, Irani chai involves prolonged "decoction"—the tea and water are simmered separately for hours to create a thick, concentrated liquid. The tea must withstand this extended boiling without turning bitter or losing its briskness. We supply ultra-fine <strong>PD (Pekoe Dust)</strong> and <strong>RD (Red Dust)</strong> grades that are specifically selected for their high color-retention and non-bitter tannin profiles.</p>

      <h3>Our Hyderabad-Specific Formulations</h3>
      
      <h4>Irani Chai Special – The Signature Blend</h4>
      <p>This is our masterpiece for Hyderabad. Formulated to release flavor slowly, it produces that characteristic syrupy liquor that pairs perfectly with Osmania biscuits. This blend is currently used by several top-tier cafes in <strong>Banjara Hills and Jubilee Hills</strong>.</p>

      <h4>Begum Bazar Wholesale Grade</h4>
      <p>The traditional wholesalers in Begum Bazar require value-focused bulk tea that can be redistributed to small cafes across the Old City. We supply 50kg HDPE bags that ensure moisture protection during rail or road transport from Siliguri to Nampally hubs.</p>

      <h4>Hotel Dust – For High-Volume Operations</h4>
      <p>Hyderabad's busy Irani cafes serve hundreds of cups daily. They need tea that maintains consistency across large batches. Our hotel dust grade delivers reliable performance from the first cup in the morning to the last one at midnight.</p>

      <h3>Hyderabad Logistics: Road & Rail Supply</h3>
      <p>Supply to Hyderabad is streamlined through regular transport routes:
      <ul>
        <li><strong>Transit Hubs:</strong> Major depots in **Komapally or Jeedimetla**.</li>
        <li><strong>Transit Time:</strong> 6-8 days from Siliguri.</li>
        <li><strong>Small Bulk (50-200kg):</strong> Dispatched via reliable parcel services for door delivery.</li>
      </ul>

      <p><strong>Ready to serve Hyderabad's Irani tradition?</strong> Contact Manish Tea Traders for samples of our Hyderabad-optimized blends. Join our network of 20+ partners in the City of Pearls.</p>
    `,
    lang: 'en',
    translationId: 'hyderabad'
  },
  {
    id: "pune",
    city: "Pune",
    slug: "tea-wholesaler-pune",
    title: "Tea Wholesalers in Pune | Amruttulya & Franchise Tea Supply",
    metaDescription: "Wholesale tea supplier for Pune's tea franchises and chains. Consistent year-round blends for Amruttulya model. Contract pricing for bulk annual orders.",
    heading: "Tea Wholesaler in Pune – Powering the Franchise Revolution",
    content: `
  ...
  },
  {
    ...
    title: "Tea Supplier in Surat, Gujarat | Premium Assam CTC & Gift Pack Quality",
    metaDescription: "Wholesale tea supplier for Surat and Gujarat. Premium quality Assam CTC for households and Diwali gift packs. Clean bloom appearance guaranteed.",
    heading: "Tea Supplier in Surat – Where Quality Is Never Compromised",
    content: `
  ...
  },
  {
    ...
    title: "Tea Wholesaler in Muzaffarpur | North Bihar Distribution Hub",
    metaDescription: "Direct tea supply to Muzaffarpur and North Bihar. Competitive wholesale rates for loose tea. Janata Blend for price-conscious rural markets.",
    heading: "Tea Wholesaler in Muzaffarpur – Gateway to North Bihar's Villages",
    content: `
    ...
    `,
    lang: 'en',
    translationId: 'muzaffarpur'
  },
  {
    id: "dhanbad",
    city: "Dhanbad",
    slug: "tea-supplier-dhanbad",
    title: "Tea Supplier in Dhanbad | Coal Belt Industrial Tea Supply",
    metaDescription: "Strong, high-caffeine tea for Dhanbad and Bokaro's industrial workforce. Bulk 50kg packaging for colliery canteens and mess halls.",
    heading: "Tea Supplier in Dhanbad – Energizing the Coal Capital",
    content: `
    ...
    `,
    lang: 'en',
    translationId: 'dhanbad'
  },
  {
    id: "indore",
    city: "Indore",
    slug: "tea-wholesaler-indore-mp",
    title: "Tea Wholesaler in Indore, MP 2026 | Poha-Jalebi Special Chai",
    metaDescription: "Supplying Indore's vibrant food scene. Strong CTC for Sarafa & Chappan Dukan. 2026 Price list for MP retailers. Direct from Siliguri Godown.",
    heading: "Tea Wholesaler in Indore, MP 2026 | Poha-Jalebi Special Chai",
    content: `
      ...
      <h3>Pairing with the Perfect Poha-Jalebi</h3>
      <p>Indore's food culture is balanced on the contrast between savory poha and sweet, syrupy jalebi. This creates a specific demand for the accompanying tea: it must be strong enough to cut through the sweetness of the jalebi, yet aromatic enough to not overpower the poha's lightness. We have developed a <strong>"Malwa Special" CTC blend</strong> that is the preferred choice for breakfast hubs in Palasia and Vijay Nagar.</p>

      <h3>Late-Night Operations: Sarafa & Chappan Dukan</h3>
      <p>Indore's markets (like Sarafa Bazar) run until 2 AM. High-volume stalls here need tea that stays fresh even in large thermos dispensers or heavy-boiling pots. Our economy dust grades are optimized for this high-vibration, fast-paced service, offering the best cost-per-cup without sacrificing that Indori Chai punch.</p>

      <h3>Logistics to Central India</h3>
      <p>Indore is well-connected to Siliguri via road transport:
      <ul>
        <li><strong>Transit Time:</strong> 7-9 days via national highways.</li>
        <li><strong>Hubs:</strong> Goods primarily reach depots in **Transport Nagar, Indore**.</li>
        <li><strong>Distribution:</strong> We also serve nearby cities like **Bhopal, Dewas, and Ujjain** through our Indore network.</li>
      </ul>

      <p><strong>Ready to serve the Malwa region?</strong> Contact us for current MP wholesale rates and sample kits. Experience why Indore's food entrepreneurs trust Siliguri's finest.</p>
    `,
    lang: 'en',
    translationId: 'indore'
  },
  {
    id: "nagpur",
    city: "Nagpur",
    ...
    metaDescription: "Wholesale tea supplier for Nagpur and Vidarbha. Dooars CTC optimised for Central India's water profile. Deliver to Wardha, Akola, Amravati. Free samples.",
    ...
    `,
    lang: 'en',
    translationId: 'nagpur',
    faqItems: [
      { question: "Do you deliver wholesale tea to Nagpur and Vidarbha?", answer: "Yes, Nagpur is a key distribution hub for us in Central India. Tea reaches Nagpur transport hubs (Sitabuldi/Itwari area) in 6–7 days from Siliguri. We also serve Wardha, Chandrapur, Akola, Amravati and surrounding Vidarbha districts. For orders above 1,000 kg we arrange direct delivery to your godown." },
      { question: "What tea varieties are popular in Vidarbha region?", answer: "Vidarbha consumers prefer bright, golden-liquor tea with a naturally sweet finish — which Dooars CTC delivers perfectly. Our Vidarbha Blend is specifically adjusted for the region's water mineral profile. Unlike North India's preference for heavy Assam, Vidarbha leans toward lighter, brisk CTC leaf (BP/BOP grade) for household use." },
      { question: "What is the transit time from Siliguri to Nagpur?", answer: "Siliguri to Nagpur takes 6–7 days via road transport, leveraging Nagpur's excellent NH connectivity. This gives Nagpur buyers a 2–3 day freshness advantage over tea routed via Delhi or Mumbai. For bulk orders above 1,000 kg, we arrange direct godown delivery within Nagpur city limits." }
    ]
  },
  {
    id: "ahmedabad",
    city: "Ahmedabad",
    slug: "tea-supplier-ahmedabad",
    title: "Tea Wholesaler in Ahmedabad — CTC, Assam & Darjeeling Tea in Bulk | Siliguri Direct",
    metaDescription: "Wholesale tea supplier for Ahmedabad and Gujarat. Premium CTC, Assam & gift-pack grade tea direct from Siliguri. Min order 50 kg. Free samples. 6–8 days delivery.",
    heading: "Tea Wholesaler in Ahmedabad — Siliguri-Fresh Tea for Gujarat's Business Capital",
    content: `
      <p>Ahmedabad is Gujarat's commercial powerhouse and one of India's fastest-growing cities for premium tea consumption. From the traders of Manek Chowk to corporate canteens in GIFT City, textile mills in Naroda to the booming retail segment on SG Road, tea consumption in Ahmedabad is substantial, sophisticated, and growing. <strong>Manish Tea Traders</strong> supplies directly from Siliguri's auction market, cutting out layers of middlemen to deliver garden-fresh tea to your Ahmedabad business.</p>

      <h3>Why Source from Siliguri for Your Ahmedabad Tea Business?</h3>
      <p>When you buy tea from a local Ahmedabad distributor, you're paying their margin on top of a Mumbai trader's margin on top of a Siliguri price — two to three layers of markup. Manish Tea Traders eliminates these middlemen entirely. We are direct auction buyers in Siliguri and dispatch straight to Ahmedabad. The result: savings of <strong>₹40–80/kg</strong> going directly to your profit margin. Additionally, fewer handling stages mean fresher tea that retains its characteristic aroma and briskness.</p>

      <h3>Products We Supply to Ahmedabad</h3>
      <ul>
        <li><strong>Premium Assam CTC (BP Grade):</strong> Gujarat's favourite — bold, aromatic, golden liquor. Available in 30 kg and 50 kg sacks.</li>
        <li><strong>Festival Gift-Pack Grade:</strong> Premium visually-appealing tea for Diwali, Navratri and wedding season gift hampers. Clean 'bloom' appearance.</li>
        <li><strong>Hotel & Canteen Dust:</strong> Fast-brewing, strong-colored tea for GIDC industrial canteens, large hotels and corporate facilities.</li>
        <li><strong>Darjeeling Orthodox:</strong> For specialty tea retailers and premium gifting — authentic GI-tagged Darjeeling from first-pick lots.</li>
        <li><strong>Economy CTC Blend:</strong> Value-priced household tea for price-sensitive retailers in older Ahmedabad markets.</li>
      </ul>

      <h3>Shipping to Ahmedabad — Transit & Minimum Order</h3>
      <p>We dispatch from Siliguri via road transport to Ahmedabad's major wholesale areas (primarily Saraspur and Naroda transport hubs). Transit time is <strong>6–8 days</strong>. Minimum order is <strong>50 kg</strong> for Ahmedabad deliveries. For bulk orders above 500 kg, we negotiate direct delivery to your godown. All consignments are dispatched with full GST invoicing and e-Way bills for smooth interstate entry.</p>

      <h3>Ahmedabad Customer Testimonial</h3>
      <p><em>"We switched from our local Ahmedabad distributor to buying directly from Manish Tea Traders. The quality difference was immediately noticeable — fresher aroma, better liquor color. On 200 kg/month, we save over ₹10,000 just on per-kg pricing."</em></p>
      <p>— Wholesale retailer, Manek Chowk, Ahmedabad</p>

      <h3>How to Order Wholesale Tea for Ahmedabad</h3>
      <p><strong>Step 1:</strong> WhatsApp or call us to request free samples of the grades you need. <strong>Step 2:</strong> We courier 200g tasting samples at no cost — test with your local water. <strong>Step 3:</strong> Place a trial order of 50–100 kg once satisfied. <strong>Step 4:</strong> We dispatch within 24 hours of payment with full documentation. Join 50+ Gujarat businesses already sourcing from Manish Tea Traders.</p>
    `,
    lang: 'en',
    faqItems: [
      { question: "Can you supply wholesale tea to Ahmedabad?", answer: "Yes, we supply premium wholesale tea to Ahmedabad and the broader Gujarat market. Tea dispatched from our Siliguri godown reaches Ahmedabad in 6–8 days via road transport. Minimum order is 50 kg. We ship to Saraspur, Naroda and other transport hubs, with direct godown delivery for orders above 500 kg. All shipments come with full GST invoicing." },
      { question: "What tea is most popular for wholesale in Ahmedabad?", answer: "Ahmedabad buyers predominantly prefer Premium Assam BP grade for household retail — it delivers the bold, aromatic, golden liquor that Gujarat consumers recognise as top quality. For festive seasons (Diwali, Navratri), gift-pack grade with superior visual bloom is in high demand. Hotel and canteen buyers prefer Hotel Dust grade for high-volume operations." },
      { question: "How much cheaper is sourcing directly from Siliguri vs Ahmedabad local dealers?", answer: "Direct sourcing from Manish Tea Traders in Siliguri saves Ahmedabad buyers ₹40–80/kg by eliminating 2–3 middleman layers. On a 200 kg/month order, that's a saving of ₹8,000–16,000 per month. You also get fresher tea with better aroma since fewer handling stages are involved between the garden and your shop." }
    ]
  }
];
